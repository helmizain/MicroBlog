...
{
    public class MicroBlogMigrationsConfiguration
      : DbMigrationsConfiguration<MicroBlogContext>
    {
        public MicroBlogMigrationsConfiguration()
        {
            this.AutomaticMigrationDataLossAllowed = true;
            this.AutomaticMigrationsEnabled = true;
        }

        protected override void Seed(MicroBlogContext context)
        {
            base.Seed(context);
